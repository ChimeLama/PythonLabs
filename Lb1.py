...
def sademoji():
	...
	t_head = play.new_circle(
	 color = "yellowgreen",
	  x=60,
	  y=180,
	  radius=45,
	)
	tophed_t=play.new_box(
	  color="yellowgreen",
	  x=60,
	  y=220,
	  width=75,
